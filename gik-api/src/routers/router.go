...
func InitRouter() *gin.Engine {
	...
	{
		ordersApi.Use(middleware.AuthMiddleware())
		ordersApi.Use(middleware.AdvancedLoggingMiddleware())
		ordersApi.GET("/list", transaction.ListOrders)
		ordersApi.PUT("/add", transaction.AddOrder)
